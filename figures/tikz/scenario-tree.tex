% September 21: move edge probabilities clear of the stage boundary; dark-blue labels
% follow the instructor annotation. Structure remains redundant in shape/text.
...
% ===================== LEFT: two stages =====================
  \node[root] (x) at (0,0) {};
  \node[left=3pt of x, align=right] {$\mathbf{x}$\\[-2pt]\scriptsize here-and-now};

  \foreach \i/\y/\p/\name in {1/1.55/{$p_1=\tfrac13$}/{$\mathbf{y}_1$},
                              2/0.00/{$p_2=\tfrac13$}/{$\mathbf{y}_2$},
                              3/-1.55/{$p_3=\tfrac13$}/{$\mathbf{y}_3$}} {
    \node[leaf] (l\i) at (3.1,\y) {};
    \draw[br] (x) -- (l\i) node[plab, pos=0.72, above, fill=white] {\p};
  ...
  \node[blue!45!black, font=\scriptsize, align=center] at (1.55,-2.75)
    {yields\\observed};
...
% ===================== RIGHT: three stages =====================
  \begin{scope}[xshift=7.9cm]
    ...
    \node[blue!45!black, font=\scriptsize] at (1.1,-2.75) {stage 2};
    \node[blue!45!black, font=\scriptsize] at (3.2,-2.75) {stage 3};
